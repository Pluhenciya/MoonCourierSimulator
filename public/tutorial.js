...
const TUT = [
  ...
  },
  {
    ...
    txt: "Три кнопки в шапке: <b>▶</b> — обычная скорость (×1), <b>⏩</b> — ускорение ×5 (удобно ждать роверов), <b>⏸</b> — пауза. Вовремя доставленный заказ даёт полную награду и +2 к рейтингу, опоздание — половину и −4.",
