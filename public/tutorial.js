...
const TUT = [
  {
    title: "Привет",
    txt: "Я тут 11 лет гонял эти роверы, так что просто запомни главное: протяни <b>7 дней</b>, не урони <b>рейтинг в ноль</b> и заработай побольше баксов.<br><br>Счёт в конце: <b>доллары + рейтинг × 30</b>. Дальше короткий ликбез, потом сама.",
    target: null, need: null, hint: "", btn: "Ну, давай 🚀",
  },
  {
    title: "Заказы (слева)",
    txt: "У каждого — вес, награда, срок и опасность зоны. У срочных красная метка и тающий таймер.<br><br>Если заказ вообще невыполним (тяжелее любого ровера или там буря) — он серый. Забудь и не мучайся.",
    target: "#orders-list", need: () => state.selOrder != null, hint: "▶ Ткни в заказ (лучше в срочный)",
    btn: "Дальше →",
  },
  {
    title: "Роверы (справа)",
    txt: "У каждого — батарея, грузоподъёмность и скорость. Заряда вечно не хватает: он тратится в пути, а заряжаются они только на базе. Так что планируй.",
    target: "#rovers-list", need: () => state.selRover != null, hint: "▶ Теперь выбери ровер",
    btn: "Дальше →",
  },
  {
    title: "Карта и зоны",
    txt: "Цвет рамки — насколько там опасно: <span style='color:#34d399'>зелёный</span> — тишь да гладь, <span style='color:#fbbf24'>жёлтый</span> — поаккуратнее, <span style='color:#f87171'>красный</span> — там тебя мама зовёт.<br><br>Пунктир — буря, туда сейчас нельзя. Снизу база, оранжевые точки — куда везти.",
    target: "#map-wrap", need: null, hint: "", btn: "Дальше →",
  },
  {
    title: "Панель «Миссия»",
    txt: "Выбрал заказ и ровер — тут посчитают маршрут: время, сколько сожрёт батареи и сколько дадут денег.<br><br>Если не хватит батареи или груз не влезет — запуск не даст, напишет причину. Так что спокойно.",
    target: "#mission-box", need: null, hint: "", btn: "Дальше →",
  },
  {
    title: "Запуск доставки",
    txt: "Жми <b>🚀 Запустить доставку</b> — ровер поедет. В опасных зонах с ним случается: пыль, ЭМИ, поломки. Следи за журналом событий внизу.",
    target: "#ma .launch",
    need: () => state.data.rovers.some((r) => r.status === "delivering" || r.status === "returning"),
    auto: true,
    hint: "▶ Подтверди отправку",
    btn: "Дальше →",
  },
  {
    title: "Время",
    txt: "Три кнопки: <b>▶</b> — обычная скорость, <b>⏩</b> — разогнать ×5 (когда ждёшь роверы — самое то), <b>⏸</b> — всё замерло.<br><br>Вовремя доставил — полная награда и +2 рейтинга. Опоздал — половина и −4. Звук, кстати, выключается кнопкой <b>🔊</b>.",
    target: "#btn-play", need: null, hint: "", btn: "Дальше →",
  },
  {
    title: "Деньги → прокачка",
    txt: "На заработанное можно прокачать роверы в <b>🛰</b> (груз, батарея, скорость) или купить новые в <b>🛒</b> — витрина обновляется каждые 10–20 минут.<br><br>Итоги потом в <b>🏆</b>: имя введёшь в конце партии.",
    target: "#btn-fleet", need: null, hint: "", btn: "Дальше →",
  },
  {
    title: "Ну и всё",
    txt: "Рейтинг в ноль — базу закроют. Не перегружай роверы, заряжай заранее, в бури не лезь — и будет норм.<br><br><a onclick=\"showHelp()\">Полные правила, если хочешь</a>",
    target: null, need: null, hint: "", btn: "Поехали 🚀",
  },
];
