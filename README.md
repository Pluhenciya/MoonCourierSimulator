...
- `python tests/smoke.py` — 11 автотестов ядра: мозаика зон без «дыр», форпосты в зонах, маршруты вне кратеров, зоны различаются по риску/скорости, отклонение невозможных миссий (перегруз / батарея / буря / занятый ровер), полный цикл доставки (деньги/батарея/статусы), штраф за опоздание, переходы победы/поражения и стабильность цикла симуляции.
